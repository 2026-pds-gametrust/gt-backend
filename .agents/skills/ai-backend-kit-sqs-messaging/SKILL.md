---
name: sqs-messaging
description: Add or change SQS producers and consumers while keeping contracts in Domain and concrete messaging in Infraestructure. Use for events, async messages, retries, or consumers.
---

# SQS messaging

1. Define event payloads and producer/consumer interfaces in Domain.
2. Implement concrete SQS clients in Infraestructure.
...
5. Define topic, message group (FIFO), versioning, idempotency, retry, DLQ, and
...
Domain must never import concrete SQS messaging libraries or clients.
