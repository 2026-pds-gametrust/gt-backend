...
> gated rules), use [`agt-architecture-probe`](../discovery/agt-architecture-probe.md),
...
The `technical-design` skill is preloaded into your context — follow it. If it
is missing, read:

```text
.claude/skills/technical-design/SKILL.md
```
...
- Mapping as-is architecture / mining patterns / rule stewardship
...
docs/specs/<feature-slug>/tasks.md   (drafts, with the /spec-driven skill)
```
