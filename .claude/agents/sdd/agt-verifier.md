...
name: agt-verifier
description: >-
  Skeptical verifier for work marked complete in this Node.js/TypeScript repo.
  Checks real evidence: files, content, wiring, contracts, tests, lint and
  AGENTS.md adherence. Use as the delivery evidence gate before merge, final
  review, or technical acceptance.
