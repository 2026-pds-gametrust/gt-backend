...
| Skill | When to use |
|-------|-------------|
| [add-http-endpoint](../add-http-endpoint/SKILL.md) | New HTTP route in an existing context |
| [openapi-contract](../openapi-contract/SKILL.md) | Sync `service.yaml` with routes and schemas |
